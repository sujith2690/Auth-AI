            ...
            <div className='bg-inherit p-2 md:p-10'>
                <div className='relative flex items-center justify-center'>
                    ...
                    <div className='absolute inset-0 flex flex-col items-center justify-center '>
                        <div className='rounded-3xl bg-gradient-to-r from-[#0788AEE5] to-[#22AAD2E5] md:gap-6 flex flex-col items-center justify-center relative p-1 w-5/6 md:p-5'>
                            ...
                            <p className='text-[#E3E3E3] text-[10px] md:text-sm text-center flex flex-col md:flex-row mb-2 md:w-1/2'>
