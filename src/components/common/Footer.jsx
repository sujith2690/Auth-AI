...
const Footer = () => {
    return (
        <footer >
            <div className=" bg-[#060F1A] text-white p-6 grid grid-cols-1 sm:grid-cols-4 gap-2">
                <div className='flex items-center justify-center'>
            ...
            <div className='flex items-center justify-center bg-[#0D151F] p-3 '>
                <div>
                    <p className='text-sm text-[#E0E2E259]'>Copyright © 2024 Haidezign. All Right Reserved.</p>
                </div>
            </div>
        </footer>
    );
